...
`kaos-mcp` requires Python 3.13 or newer. It publishes the `kaos_mcp`
import package. This package publishes CLI entry point(s): `kaos`, `kaos-mcp`.
...
include the `kaos-mcp` version, Python version, operating system,
