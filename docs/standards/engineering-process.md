...
This document defines how `kaos-mcp` handles features, bugs,
...
- What `kaos-mcp` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_mcp`.
